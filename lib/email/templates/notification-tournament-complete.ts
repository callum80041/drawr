...
export function notificationTournamentCompleteEmailHtml({
  participantName,
  sweepstakeName,
  shareToken,
  yourPoints,
...
<title>Final standings are in</title>
</head>
    ...
    <table width="100%" style="max-width:520px;background:#fff;border-radius:16px;border:1px solid ${border};overflow:hidden;">
      ...
      <tr>
        <td style="background:#1A2E22;padding:0 32px 32px;text-align:center;">
          <div style="font-size:60px;line-height:1;margin-bottom:12px;padding-top:24px;">🏆</div>
      ...
      <tr>
        <td style="padding:32px;">
          ...
          <p style="margin:0 0 24px;font-size:15px;color:#5A7265;line-height:1.6;">
            The ${isEurovision ? 'Eurovision Song Contest' : 'World Cup'} is complete. Here's how you finished in <strong style="color:#1A2E22;">${escapeHtml(sweepstakeName)}</strong>.
          </p>

          <table cellpadding="0" cellspacing="0" style="width:100%;background:${sectionBg};border-radius:12px;margin-bottom:24px;">
            <tr>
              <td style="padding:16px 20px;">
                <p style="margin:0 0 8px;font-size:11px;font-weight:600;color:#5A7265;text-transform:uppercase;letter-spacing:0.08em;">Your final score</p>
                <p style="margin:0;font-size:28px;font-weight:800;color:#1A2E22;letter-spacing:-0.5px;">${yourPoints} <span style="font-size:16px;font-weight:600;">pts</span></p>
              </td>
            </tr>
          </table>
          ...
          <table cellpadding="0" cellspacing="0" style="width:100%;background:${sectionBg};border-radius:12px;margin-bottom:24px;">
            <tr>
              <td style="padding:16px 20px;">
                <p style="margin:0 0 8px;font-size:11px;font-weight:600;color:#5A7265;text-transform:uppercase;letter-spacing:0.08em;">Winner</p>
                <p style="margin:0;font-size:18px;font-weight:700;color:#1A2E22;">🥇 ${escapeHtml(winnerName)}</p>
              </td>
            </tr>
          </table>
