/**
 * Eurovision 2026 (Vienna) — country → song mapping
 * Source: https://www.eurovision.com/stories/eurovision-vienna-2026-all-35-songs/
 *
 * Keys = team IDs from the teams table (tournament_id = 2)
 * Spotify track IDs from playlist 0LDPlemKV95Kyeu8W3UhRX
 */
...
export const EUROVISION_SONGS: Record<number, EurovisionSong> = {
  ...
  // 105 Spain withdrew from ESC 2026 — no entry
  ...
  108: { title: 'Paloma Rumba',         artist: 'Simón',                   spotifyUrl: 'https://open.spotify.com/track/4GdU371yp4pDPleTAXoq4g', spotifyTrackId: '4GdU371yp4pDPleTAXoq4g' }, // Armenia 🇦🇲
  ...
  110: { title: 'Just Go',              artist: 'JIVA',                    spotifyUrl: 'https://open.spotify.com/track/3MdXycj2PnW7KBiYSzLVxD', spotifyTrackId: '3MdXycj2PnW7KBiYSzLVxD' }, // Azerbaijan 🇦🇿
  111: { title: 'Andromeda',            artist: 'LELEK',                   spotifyUrl: 'https://open.spotify.com/track/3bTsAnErZrtBoUfORcTDTo', spotifyTrackId: '3bTsAnErZrtBoUfORcTDTo' }, // Croatia 🇭🇷
  ...
  // 115 Iceland not participating in ESC 2026
  ...
  118: { title: 'Kraj mene',            artist: 'Lavina',                  spotifyUrl: 'https://open.spotify.com/track/3cnVAUGWZcXNqojO8PfYOu', spotifyTrackId: '3cnVAUGWZcXNqojO8PfYOu' }, // Serbia 🇷🇸
  // 119 Slovenia not participating in ESC 2026
  ...
  // ── Semi-Final 2 ───────────────────────────────────────────────────────────
  121: { title: 'Dancing on the Ice',   artist: 'Essyla',                  spotifyUrl: 'https://open.spotify.com/track/1u0WYHtNFrAyzgybCDK861', spotifyTrackId: '1u0WYHtNFrAyzgybCDK861' }, // Belgium 🇧🇪
  ...
  // 126 Ireland not participating in ESC 2026
  ...
  129: { title: 'Sólo Quiero Más',      artist: 'Lion Ceccah',             spotifyUrl: 'https://open.spotify.com/track/1av4wp2KoCwn9P151n45WV', spotifyTrackId: '1av4wp2KoCwn9P151n45WV' }, // Lithuania 🇱🇹
  130: { title: 'Mother Nature',        artist: 'Eva Marija',              spotifyUrl: 'https://open.spotify.com/track/4kYfZeuXXmCWLvhnPIjyr1', spotifyTrackId: '4kYfZeuXXmCWLvhnPIjyr1' }, // Luxembourg 🇱🇺
  ...
  // 132 Netherlands not participating in ESC 2026
  ...
  // ── New countries (IDs 136-140) — added in migration 015 ──────────────────
  136: { title: 'Bangaranga',           artist: 'DARA',                    spotifyUrl: 'https://open.spotify.com/track/6SvlfrQYzUsW5UQUpUpy26', spotifyTrackId: '6SvlfrQYzUsW5UQUpUpy26' }, // Bulgaria 🇧🇬
  137: { title: 'Nova Zora',            artist: 'Tamara Živković',         spotifyUrl: 'https://open.spotify.com/track/3PGOiXT00ISVuUgr14m079', spotifyTrackId: '3PGOiXT00ISVuUgr14m079' }, // Montenegro 🇲🇪
  138: { title: 'Choke Me',             artist: 'Alexandra Căpitănescu',   spotifyUrl: 'https://open.spotify.com/track/0itI8ykSUDp4dfwiHY6fnw', spotifyTrackId: '0itI8ykSUDp4dfwiHY6fnw' }, // Romania 🇷🇴
  139: { title: 'Superstar',            artist: 'Senhit',                  spotifyUrl: 'https://open.spotify.com/track/5fYAsg12ms7UkZLtEmS4J6', spotifyTrackId: '5fYAsg12ms7UkZLtEmS4J6' }, // San Marino 🇸🇲
  140: { title: 'Alice',               artist: 'Veronica Fusaro',         spotifyUrl: 'https://open.spotify.com/track/4n1hRQ4uhTLhc1XaJFFofK', spotifyTrackId: '4n1hRQ4uhTLhc1XaJFFofK' }, // Switzerland 🇨🇭
}
